...
namespace TesteFortes.Migrations
{
    ...
    [Migration("20220918231117_Carga3")]
    partial class Carga3
    {
            ...
            modelBuilder.Entity("TesteFortes.Domain.Entities.Produto", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProdutoId = 1,
                            Codigo = "AX001",
                            DataCadastro = new DateTime(2022, 9, 18, 20, 11, 17, 10, DateTimeKind.Local).AddTicks(8888),
                        ...
                        new
                        {
                            ProdutoId = 2,
                            Codigo = "AX301",
                            DataCadastro = new DateTime(2022, 9, 18, 20, 11, 17, 10, DateTimeKind.Local).AddTicks(8894),
                        ...
                        new
                        {
                            ProdutoId = 3,
                            Codigo = "BC401",
                            DataCadastro = new DateTime(2022, 9, 18, 20, 11, 17, 10, DateTimeKind.Local).AddTicks(8895),
                        ...
                        new
                        {
                            ProdutoId = 4,
                            Codigo = "BD112",
                            DataCadastro = new DateTime(2022, 9, 18, 20, 11, 17, 10, DateTimeKind.Local).AddTicks(8897),
            ...
            modelBuilder.Entity("TesteFortes.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 9, 18, 20, 11, 17, 10, DateTimeKind.Local).AddTicks(8338));
