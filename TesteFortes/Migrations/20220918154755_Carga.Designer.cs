...
namespace TesteFortes.Migrations
{
    ...
    [Migration("20220918154755_Carga")]
    partial class Carga
    {
            ...
            modelBuilder.Entity("TesteFortes.Domain.Entities.Produto", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProdutoId = 1,
                            Codigo = "AX001",
                            DataCadastro = new DateTime(2022, 9, 18, 12, 47, 55, 526, DateTimeKind.Local).AddTicks(9858),
                        ...
                        new
                        {
                            ProdutoId = 2,
                            Codigo = "AX301",
                            DataCadastro = new DateTime(2022, 9, 18, 12, 47, 55, 526, DateTimeKind.Local).AddTicks(9864),
                        ...
                        new
                        {
                            ProdutoId = 3,
                            Codigo = "BC401",
                            DataCadastro = new DateTime(2022, 9, 18, 12, 47, 55, 526, DateTimeKind.Local).AddTicks(9866),
                        ...
                        new
                        {
                            ProdutoId = 4,
                            Codigo = "BD112",
                            DataCadastro = new DateTime(2022, 9, 18, 12, 47, 55, 526, DateTimeKind.Local).AddTicks(9867),
            ...
            modelBuilder.Entity("TesteFortes.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 9, 18, 12, 47, 55, 526, DateTimeKind.Local).AddTicks(9225));
